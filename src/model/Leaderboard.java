...
public class Leaderboard {
	...
	// TODO: Maar 1 entry per keer wordt toegevoegd, dus bubble hoeft niet. Hoef
	// alleen maar te zoeken waar deze hoort.
	...
	public static void main(String[] args) {
		...
		for (LeaderboardEntry le : testLb.getEntries()) {
			System.out
					.println(le.getName() + ", " + le.getScore() + ", " + le.getDate().toString());
		}
		testLb.sortEntries();
