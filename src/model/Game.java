...
public class Game extends Observable {
	...
	/**
	 * Creates a new game with dimensions Constants.ROWS, Constants.COLUMN, and
	 * a given playerList.
	 * 
	 * @param argPlayerList
	...
	/**
	 * Checks if adding a disk to a certain column is valid. Returns false when
	 * the disk is:<br>
	 ...
	 * 
	 * @param c
	 *            The column the disk is going to be put in
	...
	/**
	 * Returns a Map of <Mark, Player>, which is a list of Marks associated with
	 * a player.
	 * 
	 ...
	 * 
	 * @param c
	 *            The column to take a turn in.
	 * @throws FalseMoveException
	 *             If a turn is made in a full column, or a column outside of
	 *             this Board.
	 */
	 ...
	 * 
	 * @param i
	 *            The index where a Mark is pulled from.
