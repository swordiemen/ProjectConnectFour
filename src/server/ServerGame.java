...
public class ServerGame extends Game {
	 ...
	 * 
	 * @param ps
	 *            The list of Peers that are going to be in this ServerGame.
	 */
	// @ requires ps != null;
	...
	/**
	 * Takes a turn in this board, and if it's legal, sends the move to the
	 * players in the Game.
	 * 
	 * @param column
	 ...
	 * 
	 * @param p
	 *            The peer the game ended against with.
	 */
	// @ requires p != null;
